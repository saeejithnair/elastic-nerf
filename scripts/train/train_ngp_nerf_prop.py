...
ngpdensityfield_config = NGPDensityFieldConfig()
if args.scene in MIPNERF360_UNBOUNDED_SCENES:
    from elastic_nerf.nerfacc.datasets.nerf_360_v2 import SubjectLoader
...
ngpradiancefield_config = NGPRadianceFieldConfig()
radiance_field = NGPRadianceField(
    ngpradiancefield_config, aabb=aabb, unbounded=unbounded
).to(device)
